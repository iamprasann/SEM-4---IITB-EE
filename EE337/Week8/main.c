...
void main(void)
{
  ...
  lcd_init();
	...
	while(1)
	{
		...
		temperature = (x*330/1023); 															//NOTE: LM35 O/P: 10mV/°C, Refer to LM35 datasheet for more information



		x = (unsigned int) (10.0*temperature);							//Convert float value to unsigned int 
